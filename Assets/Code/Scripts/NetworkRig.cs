...
namespace Code.Scripts
{
    public class NetworkRig : NetworkBehaviour
    {
        ...
        public override void Spawned()
        {
            ...
            {
                _hardwareRig = HardwareRig.Instance;
                if (_hardwareRig == null) 
                    Debug.LogError("Нет HardWare");
            }
        }
        ...
        public override void Render()
        {
            ...
            if (IsLocalNetworkRig)
            {
                UxrAvatarRig rigLocal = _hardwareRig.avatar.AvatarRig;
                playerTransform.transform.SetPositionAndRotation(_hardwareRig.playerTransform.position,
                    _hardwareRig.playerTransform.rotation);
                //head
